...
export const PACK_TIERS: Record<PackTier, PackTierSpec> = {
  ...
  silver: {
    ...
    price: 1_000_000,
    size: 5,
    weights: { common: 10, rare: 25, epic: 35, legendary: 25, mythic: 5 },
    primary:   "#c9c9c9",
    secondary: "#7d7d7d",
    border:    "var(--ink-900)",
    glow:      "var(--glow-sky)",
  ...
  vault: {
    id: "vault",
    name: "Mythic Vault",
    blurb: "The whole vault. Half the rolls are legendary, ~1 of 5 mythic.",
    price: 10_000_000,
    size: 5,
    weights: { common: 0,  rare: 5,  epic: 25, legendary: 50, mythic: 20 },
